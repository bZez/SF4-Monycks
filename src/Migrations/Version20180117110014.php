 ...
 */
class Version20180117110014 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE sender_id user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE user_id sender_id INT DEFAULT NULL');
